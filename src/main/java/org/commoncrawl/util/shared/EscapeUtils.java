...
public class EscapeUtils {
  ...
  /**
   * Given an escaped string returned by {@link #escape} and the original set of
   * characters to escape, returns the original string.
   * 
   * @see #ESCAPE
   * @see #escape
   * 
  ...
  /**
   * Concatenates multiple strings into one string with each string separated by
   * the separator character and any ocurrences of the separator character in
   * the original strings escaped.
   * 
   * @see #split
   * 
   * @param separator
   ...
   * 
   * @param separator
   *          the character that was originally used in concatenation
   * @param s
   *          the concatenated string to split
   * 
