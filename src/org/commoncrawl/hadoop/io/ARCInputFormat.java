...
public class ARCInputFormat implements InputFormat, JobConfigurable {
    ...
    /**
     * <tt>arc.input.format.io.block.size</tt> - the property where the number
     * of bytes at a time to read from each input stream is stored.
     *
     * <p> Defaults to 32 KB.
     *
     * @see #setIOBlockSize
     */
    public static final String P_IO_BLOCK_SIZE =
        "arc.input.format.io.block.size";
    
    /**
     * <tt>arc.input.format.io.buffer.size.mb</tt> - the property where the
     * number of bytes to use for IO buffering is stored.
     *
     * <p> Defaults to 10 MB.
     *
     * @see #setIOBufferSize
     */
    public static final String P_IO_BUFFER_SIZE =
        "arc.input.format.io.buffer.size";
    
    /**
     * <tt>arc.input.format.io.timeout.ms</tt> - the property where the number
     * of milliseconds to block on input before throwing an exception is stored.
     *
     * <p> Defaults to 1 minute.
     *
     * @see #setIOTimeout
     */
    public static final String P_IO_TIMEOUT =
        "arc.input.format.io.timeout.ms";
    
    /**
     * <tt>arc.input.format.arc.source.class</tt> - the property where the
     * class name of the {@link ARCSource} implementation to use is stored.
     */
    public static final String P_ARC_SOURCE =
        "arc.input.format.arc.source.class";
    
    /**
     * Sets the number of bytes to read at a time from each input stream.
     *
     * @param job       the job to set the IO block size for
     * @param blockSize the IO block size to use
     *
     * @see #P_IO_BLOCK_SIZE
     */
     ...
     *
     * @param job        the job to set the buffer size for
     * @param bufferSize the number of bytes to use for IO buffering
     *
     ...
     * exception.
     *
     * @param job          the job to set the timeout for
     * @param milliseconds the number of milliseconds to block on input before
     ...
     *
     * @param job       the job to set the {@link ARCSource} for
     * @param arcSource the {@link Class} of the implementation to use
     *
     * @see #P_ARC_SOURCE
     */
    ...
    public void configure(JobConf job) {
        ...
        arcSource = (ARCSource)
            ReflectionUtils.newInstance(archiveSourceClass, job);
    }
