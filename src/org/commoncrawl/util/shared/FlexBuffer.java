...
/**
 * A tweaking of the hadoop Buffer class, basically allowing for cheap buffer copies 
 * (via underlying storage sharing), some copy on write support, and most importantly,
 * support of offset based backing buffers
 * 
