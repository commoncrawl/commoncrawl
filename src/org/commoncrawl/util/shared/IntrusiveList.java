 ...
 * 
 */
public class IntrusiveList<ClassType extends IntrusiveList.IntrusiveListElement<ClassType>> implements Iterable<ClassType> {
  ...
  public ClassType getHead() { return (ClassType) _head; }
  public ClassType getTail() { return (ClassType) _tail; }
  public int size() { return _itemCount; }
  ...
  public static class IntrusiveListElement<ClassType> { 
    ...
    public ClassType getPrev() { return _prev; }
    public ClassType getNext() { return _next; }
   
    public void setPrev(ClassType prev) { _prev = prev; }
    public void setNext(ClassType next) { _next = next; }
    
    ClassType getObject() { return (ClassType)this; }
  }
  
  private class IntrusiveListIterator<ClassType extends IntrusiveList.IntrusiveListElement<ClassType>> implements Iterator<ClassType> {
  ...
  private static class UnitTestElement extends IntrusiveList.IntrusiveListElement<UnitTestElement> { 
    private int _id;
    
    public UnitTestElement(int id) { _id = id; }
  ...
  public static class LinkedListTest extends TestCase
  {
    ...
    public void testGetHead()
    {
      ...
      assertEquals("Check 1",new UnitTestElement(1),several.getTail().getPrev()) ;      
    }
    public void testAddRemoveAdd()
    {
      ...
      one.addHead(new UnitTestElement(0));
      assertEquals("Check remove then add 0",new UnitTestElement(0),one.getHead()) ;
    }
    public void testIterator()
    {
      ...
      {
        assertEquals("Check several iteration",new UnitTestElement(counter++),(UnitTestElement)iterator.next()) ;
      }
    }
  }
  ...
  public void classUnitTest() throws Exception {
    ...
    IntrusiveList<UnitTestElement> detached = list.detach(list.getHead().getNext());
