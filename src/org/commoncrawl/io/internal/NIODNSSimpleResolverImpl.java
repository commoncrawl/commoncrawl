...
import org.xbill.DNS.ZoneTransferIn;
   ...
   */
/*
  public NIODNSSimpleResolverImpl() throws UnknownHostException {
    this(null);
  }
*/
  InetSocketAddress
  ...
  public byte [] doTCPClientSendRecv(SocketAddress local, SocketAddress remote, byte [] data, long endTime,boolean recycleClients) throws IOException
  {
    int pass = 0;
    byte dataOut[] = null;
...
*/              
      ...
      if (client != null) { 
        try {
          //LOG.info("Using Recycled Client for Thread:" + Thread.currentThread().getName());

          client.setEndTime(System.currentTimeMillis() + 60000);
          client.send(data);
          dataOut  = client.recv();
          
          //LOG.info("Recycled Client:" + Thread.currentThread().getName() + "  SendRcv Returned:" + dataOut);
  ...
  */              
          ...
          LOG.error("Recycled DNS Resolution Failed on Pass:"+ pass); //with Exception:" + StringUtils.stringifyException(e));
          client.cleanup();
          client = null;
        }
      }
        ...
        try {
          //LOG.info("Using NEW Client for Thread:" + Thread.currentThread().getName());
          client.setEndTime(System.currentTimeMillis() + 60000);
          if (local != null)
            client.bind(local);
          ...
          //LOG.info("NEW  Client:" + Thread.currentThread().getName() + "  SendRcv Returned:" + dataOut);
          if (dataOut == null) { 
            throw new IOException("client.recv returned NULL");
          }
