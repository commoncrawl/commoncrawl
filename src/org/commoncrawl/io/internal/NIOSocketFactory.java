...
public class NIOSocketFactory {
  ...
  static public NIOClientSocket createClientSocket(URL forURL,InetSocketAddress localBindAddress,NIOClientSocketListener socketListener)throws IOException { 
    return createClientSocket(forURL.getProtocol(),localBindAddress,socketListener);
  }
  
  static public NIOClientSocket createClientSocket(String protocol,InetSocketAddress localBindAddress,NIOClientSocketListener socketListener)throws IOException {
