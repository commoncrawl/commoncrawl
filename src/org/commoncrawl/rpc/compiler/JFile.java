...
public class JFile {
  ...
  /** Ordered list of services declared in this file */
  private ArrayList<JService> mServices;
  ...
  public JFile(String name, ArrayList<JFile> inclFiles,
      ArrayList<JRecord> recList, ArrayList<JService> serviceList) {
    mName = name;
    mInclFiles = inclFiles;
    mRecords = recList;
    mServices = serviceList;

    System.out.println("Service Count:" + serviceList.size() + "\n");
  }
  ...
  public int genCode(String language, String destDir, ArrayList<String> options)
    ...
    if (gen != null) {
      gen.genCode(mName, mInclFiles, mRecords, mServices, destDir, options);
    } else {
